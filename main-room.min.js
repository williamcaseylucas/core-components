...
void mainImage( out vec4 fragColor, in vec2 fragCoord )
{
    ...
    `},init:function(e){let t=e;e.uniforms.texRepeat={value:t.map.repeat},e.uniforms.texOffset={value:t.map.offset},e.uniforms.mb_invert={value:t.map.flipY?G.invert:!G.invert},e.uniforms.mb_offsetA={value:new THREE.Vector2(G.offsetAX+Math.random(),G.offsetAY+Math.random())},e.uniforms.mb_offsetB={value:new THREE.Vector2(G.offsetBX+Math.random(),G.offsetBY+Math.random())}},updateUniforms:function(e,t){t.uniforms.mb_time.value=.001*e}};const $=String.raw,Z=Object.assign({},w,{iChannel0:{value:null},iChannel1:{value:null}}),Q=new THREE.TextureLoader;var J,K;Q.load(P,(e=>{e.minFilter=THREE.NearestFilter,e.magFilter=THREE.NearestFilter,e.wrapS=THREE.RepeatWrapping,e.wrapT=THREE.RepeatWrapping,J=e})),Q.load("https://williamcaseylucas.github.io/core-components/1ec965c5d6df577c.jpg",(e=>{e.minFilter=THREE.NearestFilter,e.magFilter=THREE.NearestFilter,e.wrapS=THREE.RepeatWrapping,e.wrapT=THREE.RepeatWrapping,K=e}));let ee={uniforms:Z,vertexShader:{},fragmentShader:{uniforms:E+$`
        uniform sampler2D iChannel0;
